...
#[repr(C)]
pub struct CPdUI {
	pub set_title: Option<extern fn(*mut c_void, *const c_char)>,
	pub get_window_size: *mut extern fn () -> PDVec2,
	pub get_window_pos: *mut extern fn () -> PDVec2,
	pub begin_child: Option<extern fn(*const c_char, PDVec2, c_int, c_int)>,
	pub end_child: *mut extern fn () -> c_void,
	pub get_scroll_y: *mut extern fn () -> c_float,
	pub get_scroll_max_y: *mut extern fn () -> c_float,
	pub set_scroll_y: Option<extern fn(c_float)>,
	pub set_scroll_here: Option<extern fn(c_float)>,
	pub set_scroll_from_pos_y: Option<extern fn(c_float, c_float)>,
	pub set_keyboard_focus_here: Option<extern fn(c_int)>,
	pub push_font: Option<extern fn(*mut c_void)>,
	pub pop_font: *mut extern fn () -> c_void,
	pub push_style_color: Option<extern fn(c_uint, c_uint)>,
	pub pop_style_color: Option<extern fn(c_int)>,
	pub push_style_var: Option<extern fn(c_uint, c_float)>,
	pub push_style_var_vec: Option<extern fn(c_uint, PDVec2)>,
	pub pop_style_var: Option<extern fn(c_int)>,
	pub push_item_width: Option<extern fn(c_float)>,
	pub pop_item_width: *mut extern fn () -> c_void,
	pub calc_item_width: *mut extern fn () -> c_float,
	pub push_allow_keyboard_focus: Option<extern fn(c_int)>,
	pub pop_allow_keyboard_focus: *mut extern fn () -> c_void,
	pub push_text_wrap_pos: Option<extern fn(c_float)>,
	pub pop_text_wrap_pos: *mut extern fn () -> c_void,
	pub push_button_repeat: Option<extern fn(c_int)>,
	...
	pub same_line: Option<extern fn(c_int, c_int)>,
	...
	pub columns: Option<extern fn(c_int, *const c_char, c_int)>,
	pub next_column: *mut extern fn () -> c_void,
	pub get_column_index: *mut extern fn () -> c_int,
	pub get_column_offset: Option<extern fn(c_int) -> c_float>,
	pub set_column_offset: Option<extern fn(c_int, c_float)>,
	pub get_column_width: Option<extern fn(c_int) -> c_float>,
	pub get_columns_count: *mut extern fn () -> c_int,
	pub get_cursor_pos: *mut extern fn () -> PDVec2,
	pub get_cursor_pos_x: *mut extern fn () -> c_float,
	pub get_cursor_pos_y: *mut extern fn () -> c_float,
	pub set_cursor_pos: Option<extern fn(PDVec2)>,
	pub set_cursor_pos_x: Option<extern fn(c_float)>,
	pub set_cursor_pos_y: Option<extern fn(c_float)>,
	...
	pub push_id_str: Option<extern fn(*const c_char)>,
	pub push_id_str_range: Option<extern fn(*const c_char, *const c_char)>,
	pub push_id_ptr: Option<extern fn(*const c_void)>,
	pub push_id_int: Option<extern fn(c_int)>,
	pub pop_id: *mut extern fn () -> c_void,
	pub get_id_str: Option<extern fn(*const c_char) -> c_uint>,
	pub get_id_str_range: Option<extern fn(*const c_char, *const c_char) -> c_uint>,
	pub get_id_ptr: Option<extern fn(*const c_void) -> c_uint>,
	pub text: Option<extern fn(*const c_char)>,
	pub text_v: Option<extern fn(*const c_char, c_int)>,
	pub text_colored: Option<extern fn(c_uint, *const c_char)>,
	pub text_colored_v: Option<extern fn(c_uint, *const c_char, c_int)>,
	pub text_disabled: Option<extern fn(*const c_char)>,
	pub text_disabled_v: Option<extern fn(*const c_char, c_int)>,
	pub text_wrapped: Option<extern fn(*const c_char)>,
	pub text_wrapped_v: Option<extern fn(*const c_char, c_int)>,
	pub text_unformatted: Option<extern fn(*const c_char, *const c_char)>,
	pub label_text: Option<extern fn(*const c_char, *const c_char)>,
	pub label_text_v: Option<extern fn(*const c_char, *const c_char, c_int)>,
	pub bullet: *mut extern fn () -> c_void,
	pub bullet_text: Option<extern fn(*const c_char)>,
	pub bullet_text_v: Option<extern fn(*const c_char, c_int)>,
	pub button: Option<extern fn(*const c_uchar, PDVec2) -> c_int>,
	pub small_button: Option<extern fn(*const c_uchar) -> c_int>,
	pub invisible_button: Option<extern fn(*const c_char, PDVec2) -> c_int>,
	pub image: Option<extern fn(*mut c_void, PDVec2, PDVec2, PDVec2, c_uint, c_uint)>,
	pub image_button: Option<extern fn(*mut c_void, PDVec2, PDVec2, PDVec2, c_int, c_uint, c_uint) -> c_int>,
	pub collapsing_header: Option<extern fn(*const c_char, *const c_char, c_int, c_int) -> c_int>,
	pub checkbox: Option<extern fn(*const c_char, *mut c_int) -> c_int>,
	pub checkbox_flags: Option<extern fn(*const c_char, *mut c_uint, c_uint) -> c_int>,
	pub radio_buttonint: Option<extern fn(*const c_char, c_int) -> c_int>,
	pub radio_button: Option<extern fn(*const c_char, *mut c_int, c_int) -> c_int>,
	pub combo: Option<extern fn(*const c_char, *mut c_int, *mut *const c_char, c_int, c_int) -> c_int>,
	pub combo2: Option<extern fn(*const c_char, *mut c_int, *const c_char, c_int) -> c_int>,
	pub combo3: Option<extern fn(*const c_char, *mut c_int, Option<extern fn(*mut c_void, c_int, *mut *const c_char) -> c_int>, *mut c_void, c_int, c_int) -> c_int>,
	pub color_button: Option<extern fn(c_uint, c_int, c_int) -> c_int>,
	pub color_edit3: Option<extern fn(*const c_char, *mut c_float) -> c_int>,
	pub color_edit4: Option<extern fn(*const c_char, *mut c_float, c_int) -> c_int>,
	pub color_edit_mode: Option<extern fn(c_uint)>,
	pub plot_lines: Option<extern fn(*const c_char, *const c_float, c_int, c_int, *const c_char, c_float, c_float, PDVec2, c_int)>,
	pub plot_lines2: Option<extern fn(*const c_char, Option<extern fn(*mut c_void, c_int) -> c_float>, *mut c_void, c_int, c_int, *const c_char, c_float, c_float, PDVec2)>,
	pub plot_histogram: Option<extern fn(*const c_char, *const c_float, c_int, c_int, *const c_char, c_float, c_float, PDVec2, c_int)>,
	pub plot_histogram2: Option<extern fn(*const c_char, Option<extern fn(*mut c_void, c_int) -> c_float>, *mut c_void, c_int, c_int, *const c_char, c_float, c_float, PDVec2)>,
	pub sc_input_text: Option<extern fn(*const c_char, c_float, c_float, Option<extern fn(*mut c_void)>, *mut c_void) -> *mut PDUISCInterface>,
	pub slider_float: Option<extern fn(*const c_char, *mut c_float, c_float, c_float, *const c_char, c_float) -> c_int>,
	pub slider_float2: Option<extern fn(*const c_char, *mut c_float, c_float, c_float, *const c_char, c_float) -> c_int>,
	pub slider_float3: Option<extern fn(*const c_char, *mut c_float, c_float, c_float, *const c_char, c_float) -> c_int>,
	pub slider_float4: Option<extern fn(*const c_char, *mut c_float, c_float, c_float, *const c_char, c_float) -> c_int>,
	pub slider_angle: Option<extern fn(*const c_char, *mut c_float, c_float, c_float) -> c_int>,
	pub slider_int: Option<extern fn(*const c_char, *mut c_int, c_int, c_int, *const c_char) -> c_int>,
	pub slider_int2: Option<extern fn(*const c_char, *mut c_int, c_int, c_int, *const c_char) -> c_int>,
	pub slider_int3: Option<extern fn(*const c_char, *mut c_int, c_int, c_int, *const c_char) -> c_int>,
	pub slider_int4: Option<extern fn(*const c_char, *mut c_int, c_int, c_int, *const c_char) -> c_int>,
	pub vslider_float: Option<extern fn(*const c_char, PDVec2, *mut c_float, c_float, c_float, *const c_char, c_float) -> c_int>,
	pub vslider_int: Option<extern fn(*const c_char, PDVec2, *mut c_int, c_int, c_int, *const c_char) -> c_int>,
	pub drag_float: Option<extern fn(*const c_char, *mut c_float, c_float, c_float, c_float, *const c_char, c_float) -> c_int>,
	pub drag_float2: Option<extern fn(*const c_char, *mut c_float, c_float, c_float, c_float, *const c_char, c_float) -> c_int>,
	pub drag_float3: Option<extern fn(*const c_char, *mut c_float, c_float, c_float, c_float, *const c_char, c_float) -> c_int>,
	pub drag_float4: Option<extern fn(*const c_char, *mut c_float, c_float, c_float, c_float, *const c_char, c_float) -> c_int>,
	pub drag_int: Option<extern fn(*const c_char, *mut c_int, c_float, c_int, c_int, *const c_char) -> c_int>,
	pub drag_int2: Option<extern fn(*const c_char, *mut c_int, c_float, c_int, c_int, *const c_char) -> c_int>,
	pub drag_int3: Option<extern fn(*const c_char, *mut c_int, c_float, c_int, c_int, *const c_char) -> c_int>,
	pub drag_int4: Option<extern fn(*const c_char, *mut c_int, c_float, c_int, c_int, *const c_char) -> c_int>,
	pub input_text: Option<extern fn(*const c_char, *mut c_char, c_int, c_int, Option<extern fn(*mut PDUIInputTextCallbackData)>, *mut c_void) -> c_int>,
	pub input_text_multiline: Option<extern fn(*const c_char, *mut c_char, c_int, PDVec2, c_uint, Option<extern fn(*mut PDUIInputTextCallbackData)>, *mut c_void) -> c_int>,
	pub input_float: Option<extern fn(*const c_char, *mut c_float, c_float, c_float, c_int, c_uint) -> c_int>,
	pub input_float2: Option<extern fn(*const c_char, *mut c_float, c_int, c_uint) -> c_int>,
	pub input_float3: Option<extern fn(*const c_char, *mut c_float, c_int, c_uint) -> c_int>,
	pub input_float4: Option<extern fn(*const c_char, *mut c_float, c_int, c_uint) -> c_int>,
	pub input_int: Option<extern fn(*const c_char, *mut c_int, c_int, c_int, c_uint) -> c_int>,
	pub input_int2: Option<extern fn(*const c_char, *mut c_int, c_uint) -> c_int>,
	pub input_int3: Option<extern fn(*const c_char, *mut c_int, c_uint) -> c_int>,
	pub input_int4: Option<extern fn(*const c_char, *mut c_int, c_uint) -> c_int>,
	pub tree_node: Option<extern fn(*const c_char) -> c_int>,
	pub tree_node_str: Option<extern fn(*const c_char, *const c_char) -> c_int>,
	pub tree_node_ptr: Option<extern fn(*const c_void, *const c_char) -> c_int>,
	pub tree_node_str_v: Option<extern fn(*const c_char, *const c_char, c_int) -> c_int>,
	pub tree_node_ptr_v: Option<extern fn(*const c_void, *const c_char, c_int) -> c_int>,
	pub tree_push_str: Option<extern fn(*const c_char)>,
	pub tree_push_ptr: Option<extern fn(*const c_void)>,
	pub tree_pop: *mut extern fn () -> c_void,
	pub set_next_tree_node_opened: Option<extern fn(c_int, c_uint)>,
	pub selectable: Option<extern fn(*const c_char, c_int, c_uint, PDVec2) -> c_int>,
	pub selectable_ex: Option<extern fn(*const c_char, *mut c_int, c_uint, PDVec2) -> c_int>,
	pub list_box: Option<extern fn(*const c_char, *mut c_int, *mut *const c_char, c_int, c_int) -> c_int>,
	pub list_box2: Option<extern fn(*const c_char, *mut c_int, Option<extern fn(*mut c_void, c_int, *mut *const c_char) -> c_int>, *mut c_void, c_int, c_int) -> c_int>,
	pub list_box_header: Option<extern fn(*const c_char, PDVec2) -> c_int>,
	pub list_box_header2: Option<extern fn(*const c_char, c_int, c_int) -> c_int>,
	pub list_box_footer: *mut extern fn () -> c_void,
	pub set_tooltip: Option<extern fn(*const c_char)>,
	pub set_tooltip_v: Option<extern fn(*const c_char, c_int)>,
	...
	pub begin_menu: Option<extern fn(*const c_char, c_int) -> c_int>,
	pub end_menu: *mut extern fn () -> c_void,
	pub menu_item: Option<extern fn(*const c_char, *const c_char, c_int, c_int) -> c_int>,
	pub menu_item_ptr: Option<extern fn(*const c_char, *const c_char, *mut c_int, c_int) -> c_int>,
	pub open_popup: Option<extern fn(*const c_char)>,
	pub begin_popup: Option<extern fn(*const c_char) -> c_int>,
	pub begin_popup_modal: Option<extern fn(*const c_char, *mut c_int, c_uint) -> c_int>,
	pub begin_popup_context_item: Option<extern fn(*const c_char, c_int) -> c_int>,
	pub begin_popup_context_window: Option<extern fn(c_int, *const c_char, c_int) -> c_int>,
	pub begin_popup_context_void: Option<extern fn(*const c_char, c_int) -> c_int>,
	pub end_popup: *mut extern fn () -> c_void,
	pub close_current_popup: *mut extern fn () -> c_void,
	pub value_int: Option<extern fn(*const c_char, c_int)>,
	pub value_u_int: Option<extern fn(*const c_char, c_uint)>,
	pub value_float: Option<extern fn(*const c_char, c_float, *const c_char)>,
	pub color: Option<extern fn(*const c_char, c_uint)>,
	pub log_to_tty: Option<extern fn(c_int)>,
	pub log_to_file: Option<extern fn(c_int, *const c_char)>,
	pub log_to_clipboard: Option<extern fn(c_int)>,
	...
	pub is_rect_visible: Option<extern fn(PDVec2) -> c_int>,
	pub is_pos_hovering_any_window: Option<extern fn(PDVec2) -> c_int>,
	pub get_time: *mut extern fn () -> c_float,
	pub get_frame_count: *mut extern fn () -> c_int,
	pub get_style_col_name: Option<extern fn(c_uint) -> *const c_char>,
	pub calc_item_rect_closest_point: Option<extern fn(PDVec2, c_int, c_float) -> PDVec2>,
	pub calc_text_size: Option<extern fn(*const c_char, *const c_char, c_int, c_float) -> PDVec2>,
	pub calc_list_clipping: Option<extern fn(c_int, c_float, *mut c_int, *mut c_int)>,
	pub begin_child_frame: Option<extern fn(c_uint, PDVec2) -> c_int>,
	pub end_child_frame: *mut extern fn () -> c_void,
	pub color_convert_rg_bto_hsv: Option<extern fn(c_float, c_float, c_float, *mut c_float, *mut c_float, *mut c_float)>,
	pub color_convert_hs_vto_rgb: Option<extern fn(c_float, c_float, c_float, *mut c_float, *mut c_float, *mut c_float)>,
	pub is_key_down: Option<extern fn(c_int) -> c_int>,
	pub is_key_pressed: Option<extern fn(c_int, c_int) -> c_int>,
	pub is_key_released: Option<extern fn(c_int) -> c_int>,
	pub is_key_down_id: Option<extern fn(c_uint, c_int) -> c_int>,
	pub is_mouse_down: Option<extern fn(c_int) -> c_int>,
	pub is_mouse_clicked: Option<extern fn(c_int, c_int) -> c_int>,
	pub is_mouse_double_clicked: Option<extern fn(c_int) -> c_int>,
	pub is_mouse_released: Option<extern fn(c_int) -> c_int>,
	pub is_mouse_hovering_window: *mut extern fn () -> c_int,
	pub is_mouse_hovering_any_window: *mut extern fn () -> c_int,
	pub is_mouse_hovering_rect: Option<extern fn(PDVec2, PDVec2) -> c_int>,
	pub is_mouse_dragging: Option<extern fn(c_int, c_float) -> c_int>,
	pub get_mouse_pos: *mut extern fn () -> PDVec2,
	pub get_mouse_drag_delta: Option<extern fn(c_int, c_float) -> PDVec2>,
	pub reset_mouse_drag_delta: Option<extern fn(c_int)>,
	pub get_mouse_cursor: *mut extern fn () -> c_uint,
	pub set_mouse_cursor: Option<extern fn(c_uint)>,
	pub fill_rect: Option<extern fn(PDRect, c_uint)>,
	pub private_data: *mut c_void,
}
...
// pub deltaX: c_float,
// pub deltaY: c_float,
// pub wheelDelta: c_short,
// pub rotation: c_short,
// pub wheelAxis: c_int,
// pub keyFlags: c_int,
// pub linesPerRotation: c_int,
// pub columnsPerRotation: c_int,
// }
//
...
// }
// bitflags! {
// flags PDUISelectableFlags_: c_uint {
// const PDUISelectableFlags_DontClosePopups =	1 as c_uint,
// const PDUISelectableFlags_SpanAllColumns =	2 as c_uint,
// }
// }
//
...
// }
// bitflags! {
// flags PDUIColorEditMode: c_int {
// const PDUIColorEditMode_UserSelect =	-2 as c_int,
// const PDUIColorEditMode_UserSelectShowButton =	-1 as c_int,
// const PDUIColorEditMode_RGB =	0 as c_int,
// const PDUIColorEditMode_HSV =	1 as c_int,
// const PDUIColorEditMode_HEX =	2 as c_int,
// }
// }
//
...
// }
// bitflags! {
// flags PDUISetCond_: c_uint {
// const PDUISetCond_Always =	1 as c_uint,
// const PDUISetCond_Once =	2 as c_uint,
// const PDUISetCond_FirstUseEver =	4 as c_uint,
// const PDUISetCond_Appearing =	8 as c_uint,
// }
// }
//
...
// }
// bitflags! {
// flags PDUIMouseCursor: c_uint {
// const PDUIMouseCursor_Arrow =	0 as c_uint,
// const PDUIMouseCursor_TextInput =	1 as c_uint,
// const PDUIMouseCursor_Move =	2 as c_uint,
// const PDUIMouseCursor_ResizeNS =	3 as c_uint,
// const PDUIMouseCursor_ResizeEW =	4 as c_uint,
// const PDUIMouseCursor_ResizeNESW =	5 as c_uint,
// const PDUIMouseCursor_ResizeNWSE =	6 as c_uint,
// }
// }
//
...
// }
// bitflags! {
// flags PDUICol: c_uint {
// const PDUICol_Text =	0 as c_uint,
// const PDUICol_TextDisabled =	1 as c_uint,
// const PDUICol_WindowBg =	2 as c_uint,
// const PDUICol_ChildWindowBg =	3 as c_uint,
// const PDUICol_Border =	4 as c_uint,
// const PDUICol_BorderShadow =	5 as c_uint,
// const PDUICol_FrameBg =	6 as c_uint,
// const PDUICol_FrameBgHovered =	7 as c_uint,
// const PDUICol_FrameBgActive =	8 as c_uint,
// const PDUICol_TitleBg =	9 as c_uint,
// const PDUICol_TitleBgCollapsed =	10 as c_uint,
// const PDUICol_TitleBgActive =	11 as c_uint,
// const PDUICol_MenuBarBg =	12 as c_uint,
// const PDUICol_ScrollbarBg =	13 as c_uint,
// const PDUICol_ScrollbarGrab =	14 as c_uint,
// const PDUICol_ScrollbarGrabHovered =	15 as c_uint,
// const PDUICol_ScrollbarGrabActive =	16 as c_uint,
// const PDUICol_ComboBg =	17 as c_uint,
// const PDUICol_CheckMark =	18 as c_uint,
// const PDUICol_SliderGrab =	19 as c_uint,
// const PDUICol_SliderGrabActive =	20 as c_uint,
// const PDUICol_Button =	21 as c_uint,
// const PDUICol_ButtonHovered =	22 as c_uint,
// const PDUICol_ButtonActive =	23 as c_uint,
// const PDUICol_Header =	24 as c_uint,
// const PDUICol_HeaderHovered =	25 as c_uint,
// const PDUICol_HeaderActive =	26 as c_uint,
// const PDUICol_Column =	27 as c_uint,
// const PDUICol_ColumnHovered =	28 as c_uint,
// const PDUICol_ColumnActive =	29 as c_uint,
// const PDUICol_ResizeGrip =	30 as c_uint,
// const PDUICol_ResizeGripHovered =	31 as c_uint,
// const PDUICol_ResizeGripActive =	32 as c_uint,
// const PDUICol_CloseButton =	33 as c_uint,
// const PDUICol_CloseButtonHovered =	34 as c_uint,
// const PDUICol_CloseButtonActive =	35 as c_uint,
// const PDUICol_PlotLines =	36 as c_uint,
// const PDUICol_PlotLinesHovered =	37 as c_uint,
// const PDUICol_PlotHistogram =	38 as c_uint,
// const PDUICol_PlotHistogramHovered =	39 as c_uint,
// const PDUICol_TextSelectedBg =	40 as c_uint,
// const PDUICol_TooltipBg =	41 as c_uint,
// const PDUICol_ModalWindowDarkening =	42 as c_uint,
// const PDUICol_COUNT =	43 as c_uint,
// }
// }
//
...
// }
// bitflags! {
// flags PDUIStyleVar: c_uint {
// const PDUIStyleVar_Invalid =	0 as c_uint,
// const PDUIStyleVar_Alpha =	1 as c_uint,
// const PDUIStyleVar_WindowPadding =	2 as c_uint,
// const PDUIStyleVar_WindowRounding =	3 as c_uint,
// const PDUIStyleVar_FramePadding =	4 as c_uint,
// const PDUIStyleVar_FrameRounding =	5 as c_uint,
// const PDUIStyleVar_ItemSpacing =	6 as c_uint,
// const PDUIStyleVar_ItemInnerSpacing =	7 as c_uint,
// const PDUIStyleVar_TreeNodeSpacing =	8 as c_uint,
// const PDUIStyleVar_Count =	9 as c_uint,
// }
// }
//
